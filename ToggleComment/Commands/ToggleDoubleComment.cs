...
namespace ToggleComment
{
    ...
    {
        private bool optionMoveCaretDown2C = false;
        private bool optionMoveCaretDown2U = false;

        [Category("Toggle Double Comment")]
        [DisplayName("Move caret down when commenting.")]
        [Description("Place the caret below the selection when commenting.")]
        public bool OptionMoveCaretDown2C
        {
            get { return optionMoveCaretDown2C; }
            set { optionMoveCaretDown2C = value; }
        }

        [Category("Toggle Double Comment")]
        [DisplayName("Move caret down when uncommenting.")]
        [Description("Place the caret below the selection when uncommenting.")]
        public bool OptionMoveCaretDown2U
        {
            get { return optionMoveCaretDown2U; }
            set { optionMoveCaretDown2U = value; }
        }
    }
    #endregion
    ...
    /// </summary>
    internal sealed class ToggleDoubleComment : CommandBase
    {
        /// <summary>
        /// コマンドのIDです。
        /// </summary>
        ...
        /// シングルトンのインスタンスを取得します。
        /// </summary>
        public static ToggleDoubleComment Instance { get; private set; }

        /// <summary>
        /// インスタンスを初期化します。
        /// </summary>
        /// <param name="package">コマンドを提供するパッケージ</param>
        private ToggleDoubleComment(Package package) : base(package, CommandId, CommandSet){}
        ...
        {
            Instance = new ToggleDoubleComment(package);
        }
        protected override void OnExecute(string language, ICodeCommentPattern[] patterns, TextSelection selection)
        {
            ...
            if (isComment)
            {
                ...
                ExecuteCommand(VSConstants.VSStd2KCmdID.UNCOMMENT_BLOCK);
                if (Config.OptionMoveCaretDown2U)
            ...
            else
            {
                ...
                ExecuteCommand(VSConstants.VSStd2KCmdID.COMMENT_BLOCK);
                if (Config.OptionMoveCaretDown2C)
                    ExecuteCommand(VSConstants.VSStd2KCmdID.DOWN);
            }
        }
